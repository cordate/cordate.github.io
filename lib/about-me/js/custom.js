...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'/lib/about-me/images/bg-slider/bg-1.jpg', fade:1000 },
		{ src:'/lib/about-me/images/bg-slider/bg-2.jpg', fade:1000 },
		{ src:'/lib/about-me/images/bg-slider/bg-3.jpg', fade:1000 }
	  ]
	})();
});
	...
	$('.view-project').on('click', function(e) {
		...
		setTimeout(function(){
            contentLoaded.load(href, function(){
				...
				contentLoaded.html("<img src=" + href + "></img>");
			});
        },400);
